...
func (s *LoanService) GetAllLoans(ctx context.Context, pageN, pageSize int32, orderBy string, isDesc bool) ([]*loan.Loan, error) {
	return s.loanRepo.GetAll(ctx, pageN, pageSize, orderBy, isDesc)
}
...
func (s *LoanService) GetAllLoanPayments(ctx context.Context, pageN, pageSize int32, orderBy string, isDesc bool) ([]*loan.LoanPayment, error) {
	return s.loanPaymentRepo.GetAll(ctx, pageN, pageSize, orderBy, isDesc)
}
