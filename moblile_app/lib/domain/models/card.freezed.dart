...
class _$CardImpl implements _Card {
  ...
  @override
  String toString() {
    return 'Card(id: $id, accountId: $accountId, cardNumber: $cardNumber, expiryDate: $expiryDate, status: $status)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, accountId, cardNumber, expiryDate, status);
