...
from . import login_log_pb2 as login__log__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in login_log_analytic_pb2_grpc.py depends on'
...
class LoginLogAnalyticServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessGetAll = channel.unary_unary(
                '/protos.LoginLogAnalyticService/ProcessGetAll',
        ...
        self.ProcessGetById = channel.unary_unary(
                '/protos.LoginLogAnalyticService/ProcessGetById',
        ...
        self.ProcessGetByIds = channel.unary_unary(
                '/protos.LoginLogAnalyticService/ProcessGetByIds',
        ...
        self.ProcessGetByCustomer = channel.unary_unary(
                '/protos.LoginLogAnalyticService/ProcessGetByCustomer',
                request_serializer=login__log__pb2.GetLoginLogsByCustomerRequest.SerializeToString,
                response_deserializer=login__log__pb2.GetAllLoginLogsResponse.FromString,
                _registered_method=True)
        self.ProcessGetInTimeRange = channel.unary_unary(
                '/protos.LoginLogAnalyticService/ProcessGetInTimeRange',
        ...
        self.ProcessGetCount = channel.unary_unary(
                '/protos.LoginLogAnalyticService/ProcessGetCount',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=custom__types__pb2.CountResponse.FromString,
                _registered_method=True)


class LoginLogAnalyticServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def ProcessGetInTimeRange(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_LoginLogAnalyticServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ProcessGetInTimeRange': grpc.unary_unary_rpc_method_handler(
                    servicer.ProcessGetInTimeRange,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'protos.LoginLogAnalyticService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('protos.LoginLogAnalyticService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class LoginLogAnalyticService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    @staticmethod
    def ProcessGetInTimeRange(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
