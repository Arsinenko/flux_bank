...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in transaction_category_analytic_pb2_grpc.py depends on'
...
class TransactionCategoryAnalyticServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessGetAll = channel.unary_unary(
                '/protos.TransactionCategoryAnalyticService/ProcessGetAll',
        ...
        self.ProcessGetById = channel.unary_unary(
                '/protos.TransactionCategoryAnalyticService/ProcessGetById',
        ...
        self.ProcessGetByIds = channel.unary_unary(
                '/protos.TransactionCategoryAnalyticService/ProcessGetByIds',
        ...
        self.ProcessGetCount = channel.unary_unary(
                '/protos.TransactionCategoryAnalyticService/ProcessGetCount',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=custom__types__pb2.CountResponse.FromString,
                _registered_method=True)


class TransactionCategoryAnalyticServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_TransactionCategoryAnalyticServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'protos.TransactionCategoryAnalyticService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('protos.TransactionCategoryAnalyticService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class TransactionCategoryAnalyticService(object):
    """Missing associated documentation comment in .proto file."""
