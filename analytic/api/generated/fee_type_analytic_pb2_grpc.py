...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in fee_type_analytic_pb2_grpc.py depends on'
...
class FeeTypeAnalyticServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessGetAll = channel.unary_unary(
                '/protos.FeeTypeAnalyticService/ProcessGetAll',
        ...
        self.ProcessGetById = channel.unary_unary(
                '/protos.FeeTypeAnalyticService/ProcessGetById',
...
def add_FeeTypeAnalyticServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'protos.FeeTypeAnalyticService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('protos.FeeTypeAnalyticService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class FeeTypeAnalyticService(object):
    """Missing associated documentation comment in .proto file."""
