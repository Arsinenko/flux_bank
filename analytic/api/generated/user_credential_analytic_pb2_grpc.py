...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in user_credential_analytic_pb2_grpc.py depends on'
...
class UserCredentialAnalyticServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessGetAll = channel.unary_unary(
                '/protos.UserCredentialAnalyticService/ProcessGetAll',
        ...
        self.ProcessGetById = channel.unary_unary(
                '/protos.UserCredentialAnalyticService/ProcessGetById',
        ...
        self.ProcessGetByIds = channel.unary_unary(
                '/protos.UserCredentialAnalyticService/ProcessGetByIds',
                request_serializer=user__credential__pb2.GetUserCredentialByIdsRequest.SerializeToString,
                response_deserializer=user__credential__pb2.GetAllUserCredentialsResponse.FromString,
                _registered_method=True)
        self.ProcessGetByUsername = channel.unary_unary(
                '/protos.UserCredentialAnalyticService/ProcessGetByUsername',
        ...
        self.ProcessGetCount = channel.unary_unary(
                '/protos.UserCredentialAnalyticService/ProcessGetCount',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=custom__types__pb2.CountResponse.FromString,
                _registered_method=True)


class UserCredentialAnalyticServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def ProcessGetByUsername(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_UserCredentialAnalyticServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ProcessGetByUsername': grpc.unary_unary_rpc_method_handler(
                    servicer.ProcessGetByUsername,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'protos.UserCredentialAnalyticService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('protos.UserCredentialAnalyticService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class UserCredentialAnalyticService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    @staticmethod
    def ProcessGetByUsername(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
